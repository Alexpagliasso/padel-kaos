...
export function AnimatedCardReveal({
  ...
  return (
    <motion.article
      ...
      whileHover={{ y: -4 }}
      className="rounded border border-[var(--event-primary)]/30 bg-[#171717] p-4 shadow-[0_0_30px_rgba(255,208,0,0.08)]"
    >
      <div className="mb-5 flex items-start justify-between gap-3">
        <span className="grid size-10 place-items-center rounded bg-[var(--event-primary)] text-black">
